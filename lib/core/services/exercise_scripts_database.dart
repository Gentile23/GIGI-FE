...
class ExerciseCoachingScript {
  ...
  /// This acts as the offline fallback when the AI/backend script is unavailable.
  String getGuidedExecutionScript(String userName) {
    final namePrefix = userName.isNotEmpty ? '$userName, ' : '';
    return '''
${namePrefix}partiamo dalla posizione per $exerciseName: ti guido io, un dettaglio alla volta...

Sistema prima il corpo... $positionSetup...

Blocca l'appoggio, allunga la schiena, abbassa le spalle e tieni il core attivo...

Immagina questo: $visualizationCue...

Senti $muscleGroups pronti a lavorare, senza scatti e senza compensi...

Prima ripetizione: $breathingCue... parti lento... $movementDescription...

Fermati un istante nel punto finale mantenendo la postura...

Ora torna controllando, senza rimbalzare e senza perdere le spalle...

Seconda ripetizione: stesso setup... rallenta se il corpo scappa...

Ripeti il movimento pulito, senti la tensione giusta e chiudi con controllo...

Questa è la traiettoria. Ora ripeti così nelle tue serie.
''';
  }
