...
class _AuthScreenState extends State<AuthScreen>
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CleanCard(
                          ...
                          enableGlass: true,
                          hasShadow: true,
                          backgroundColor: CleanTheme.surfaceColor.withValues(
                            alpha: 0.8,
                          ),
                          padding: const EdgeInsets.all(24.0),
                          child: Column(
                              ...
                              _buildTextField(
                                    ...
                                    validator: (value) {
                                      ...
                                      return ValidationUtils.validatePassword(
                                        value,
                                        enterPasswordMsg: AppLocalizations.of(
                                          context,
                                        )!.enterPassword,
                                        tooShortMsg: AppLocalizations.of(
                                          context,
                                        )!.passwordTooShort,
                                        uppercaseMsg: AppLocalizations.of(
                                          context,
                                        )!.passwordRequirementUppercase,
                                        numberMsg: AppLocalizations.of(
                                          context,
                        ...
                        Row(
                          children: [
                            const Expanded(
                              child: Divider(color: CleanTheme.borderSecondary),
                            ),
                            Padding(
                        ...
                        if (kIsWeb)
                          ...
                          Column(
                            children: [
                              Opacity(
                                opacity: (!_isLogin && !_allConsentsAccepted)
                                    ? 0.5
                                    : 1.0,
  ...
  Future<void> _handleSubmit() async {
    ...
    if (!_isLogin && !_allConsentsAccepted) {
      setState(
        () => _errorMessage =
            AppLocalizations.of(context)?.mustAcceptConsents ??
            'Devi accettare tutti i consensi per registrarti.',
      );
      return;
    }
                      ...
                      : () async {
                          ...
                          if (otpState != null && otpState.validate()) {
                            ...
                            final success = await authProvider
                                .verifyRegistrationOtp(_otpController.text);
                            if (mounted) {
